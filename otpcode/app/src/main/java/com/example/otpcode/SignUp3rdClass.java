    ...
    public void callVerifyOTPScreen(View view) {
        ...
        checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(com.taimoorsikander.cityguide.Common.LoginSignup.SignUp3rdClass.this, pairs);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(com.example.cityguide.Common.LoginSignup.SignUp3rdClass.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                progressbar.setVisibility(View.GONE);
            }
        });
